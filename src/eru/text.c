...
static const u8 font8x8[128][8] = {
    ...
    ['@'] = {0x3C,0x66,0xDE,0xDE,0xDE,0x60,0x3C,0x00},
...
void eru_char(struct eru_ctx *ctx, u32 x, u32 y, char c, u32 fg, u32 bg) {
    const u8 *glyph = font8x8[(u8)c];
    for (u32 row = 0; row < 8; row++) {
        for (u32 col = 0; col < 8; col++) {
            u32 color = (glyph[row] & (0x80 >> col)) ? fg : bg;
            eru_pixel(ctx, x + col, y + row, color);
        }
    }
}
